...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(24), __webpack_require__(60)(module)))
...
var _beers = __webpack_require__(12);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function addToCart(id) {
      this.setState({
        cart: [].concat(_toConsumableArray(this.state.cart), [{ id: id, quantity: 1 // TO-DO: increment if already added
        }]),
        onListing: false
      });
    }
    ...
    value: function render() {
      ...
      var cart = _react2.default.createElement(_Cart2.default, { cart: this.state.cart, keepShopping: this.keepShopping.bind(this) });
      var listing = _react2.default.createElement(_Listing2.default, { beers: _beers2.default.beers, addToCart: this.addToCart.bind(this) });
...
var _CartItem = __webpack_require__(72);
...
var Cart = function (_React$Component) {
  ...
  _createClass(Cart, [{
    ...
    value: function deleteItem(id) {
      var cart = this.state.cart.filter(function (item) {
        return item.id !== id;
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'tbody',
            null,
            this.props.cart.map(function (item, id) {
              var name = getNameFromId(item.id);
              return _react2.default.createElement(_CartItem2.default, { key: id,
                item: item,
                deleteFromCart: _this2.deleteItem.bind(_this2)
              });
            })
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: '#', onClick: this.props.keepShopping },
            'Continue shopping'
          ),
          _react2.default.createElement(
            'button',
...
function getNameFromId(id) {
  var beer = _beers2.default.beers.find(function (beer) {
    return beer.id === id;
  });
  return beer.name;
}
        ...
        _react2.default.createElement(
          'button',
          {
            onClick: function onClick() {
              return props.deleteFromCart(props.item.id);
            } },
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      props.beers.map(function (beer) {
        return _react2.default.createElement(_BeerListItem2.default, { key: beer.id, beer: beer, addToCart: props.addToCart });
      })
    )
  );
};
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { href: '#',
          className: 'cart-link',
          onClick: function onClick() {
            return props.addToCart(beer.id);
          } },
        'Add to cart'
      )
    )
